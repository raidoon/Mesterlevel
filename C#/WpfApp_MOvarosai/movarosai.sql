...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Nov 12. 05:59
...
-- Adatbázis: `movarosai`
--
CREATE DATABASE IF NOT EXISTS `movarosai` DEFAULT CHARACTER SET utf8 COLLATE utf8_hungarian_ci;
USE `movarosai`;
...
INSERT INTO `megye` (`megye_id`, `mnev`) VALUES
(1, 'Bács-Kiskun'),
(2, 'Baranya'),
(3, 'Békés'),
...
INSERT INTO `varos` (`varos_id`, `vnev`, `vtipid`, `megyeid`, `jaras`, `kisterseg`, `nepesseg`, `terulet`) VALUES
...
(347, 'Újváros', 5, 10, 'Berettyóújfalui', 'Berettyóújfalui', 10000, 100.33);

-- --------------------------------------------------------

--
-- Tábla szerkezet ehhez a táblához `varostipus`
--

CREATE TABLE `varostipus` (
  `vtip_id` int(11) NOT NULL,
  `vtip` varchar(40) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;

--
-- A tábla adatainak kiíratása `varostipus`
--

INSERT INTO `varostipus` (`vtip_id`, `vtip`) VALUES
(1, 'főváros'),
...
--
-- A tábla indexei `varostipus`
--
ALTER TABLE `varostipus`
  ADD PRIMARY KEY (`vtip_id`);
...
--
ALTER TABLE `varos`
  ADD CONSTRAINT `FK_varos_megye` FOREIGN KEY (`megyeid`) REFERENCES `megye` (`megye_id`),
  ADD CONSTRAINT `FK_varos_varostipus` FOREIGN KEY (`vtipid`) REFERENCES `varostipus` (`vtip_id`);
COMMIT;
